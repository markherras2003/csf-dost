...
<header class="main-header">
    <?= Html::a(Html::img(Yii::$app->request->baseUrl."/images/logo.png",['title'=>'Customer Service Feedback','alt'=>'Customer Service Feedback','height'=>'45px','width'=>'100%']), Yii::$app->homeUrl, ['class' => 'logo']) ?>
